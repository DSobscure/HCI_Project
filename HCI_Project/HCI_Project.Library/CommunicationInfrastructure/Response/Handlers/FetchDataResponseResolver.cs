...
namespace HCI_Project.Library.CommunicationInfrastructure.Response.Handlers
{
    public abstract class FetchDataResponseResolver<TSubject, TOperationCode, TFetchDataCode> : ResponseHandler<TSubject, TOperationCode>
    {
